...
#define INSTANT_NOISE_THRESHOLD_DB (80)
#define OBSERVATION_DURATION_SECOND (10*1000) //ms
#define TIME_IGNORE_NOISE (1000) //ms
#define NOISE_EVENT_COUNT_THRESHOLD (3)

//#define RECORD_1s_LEN 1000*1000/TIME_IRQ
// 10000を超えるデータはDRAMが足りない。PSRAMを使う必要がある。
#define RECORD_BEFORE_LEN (20)
#define RECORD_AFTER_LEN (20)
#define RECORD_MAX_LEN (RECORD_BEFORE_LEN + RECORD_AFTER_LEN)

#define TIME_IRQ (30*1000) //us
// デシベル計算用の積分時間　
#define TIME_INTEGRAL_DETECT (300*1000) //us
