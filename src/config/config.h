...
// 騒音検出
#define NOISE_ALERT_THRESHOLD_DB 70
...
#define TIME_INTEGRAL (30*1000*10) //us
#define INTEGRAL_SAMPLES (TIME_INTEGRAL / TIME_WAVE)

#define TIME_IRQ (100*1000) //us
#define TIME_INTEGRAL_DETECT (100*1000*10) //us
...
#define RECORD_BEFORE_LEN (50)
#define RECORD_AFTER_LEN (50)
